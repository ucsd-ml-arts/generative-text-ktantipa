...
<sub>*Side Note: My original idea was to generate the IT screenplay, however I decided to change to Goosebumps: Welcome to the Dead House text since the storyline is a lot more interesting and at the same time easier to understand for the audience. (I also kept the same halloween concept)</sub>
